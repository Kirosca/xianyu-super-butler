...
class GoofishCrawlManager:
    ...
    async def _upsert_items(
        ...
        is_sqlite = bool(session.bind and "sqlite" in str(session.bind.url))
        if is_sqlite:
            from sqlalchemy.dialects.sqlite import insert as sqlite_insert
            for v in values:
                stmt = sqlite_insert(GoofishCrawlItem).values(v).on_conflict_do_update(
                    ...
                    set_={
                        ...
                        'want_count': v['want_count'],
                        'view_count': v['view_count'],
                        'description': v['description'],
                        'detail_error': v['detail_error'],
